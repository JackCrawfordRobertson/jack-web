...
const FullScreenComponent = () => {
    ...
    const quotes = {
        ...
        "for recruiters": "As an information designer, I transform complex systems into engaging narratives, from economics to politics. I thrive on using creativity and design thinking to make real-world impacts through collaborative work.",
        "for engineers": "I'm not a software engineer, but I know how to communicate complex systems like Social Science and Climate Change. I speak fluently with developers, translating ideas into engaging, interactive experiences.",
    };
